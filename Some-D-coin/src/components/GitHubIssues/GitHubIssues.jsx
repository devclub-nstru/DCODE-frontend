        ...
        <div className="action-buttons">
          <button className="outline-button">
            ...
            >
              <path d="M9 7 6 4 3 7" />
              <path d="M6 4v16" />
              <path d="M21 10V8a2 2 0 0 0-2-2h-6" />
              <path d="M21 16v2a2 2 0 0 1-2 2h-6" />
              <path d="M16 12H3" />
              <path d="M16 6H3" />
              <path d="M16 18H3" />
            </svg>
          ...
          <div className="filters">
            {[
              ...
              <FilterDropdown
                key={filter}
                label={filter}
                onSelect={(option) => filterIssues(`${filter}: ${option}`)}
              />
            ))}
            <FilterDropdown
              label="Newest"
              icon={true}
              onSelect={(option) => filterIssues(`Sort: ${option}`)}
            />
          </div>
        </div>
      </div>
          ...
          <div key={issue.id} className="issue-item">
            ...
            <div className="issue-content">
              <div className="issue-title-row">
                <a href="#" className="issue-title">{issue.title}</a>
              ...
              <div className="issue-meta">
                {issue.number} • {issue.author} opened on {issue.openedOn}
              </div>
            </div>
...
const FilterDropdown = ({ label, icon = false, onSelect }) => {
